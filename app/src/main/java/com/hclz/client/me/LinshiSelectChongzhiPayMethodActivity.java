...
public class LinshiSelectChongzhiPayMethodActivity extends BaseActivity {
    ...
    BCCallback bcCallback = new BCCallback() {
        ...
        public void done(BCResult bcResult) {
            ...
            LinshiSelectChongzhiPayMethodActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
...
//                      getBillInfoByID(bcPayResult.getId());
     ...
     * @param zhifu_mid
     */
    public static void startMe(Context from ,String billId ,long payment_amount,String zhifu_mid){
        Intent intent = new Intent(from, LinshiSelectChongzhiPayMethodActivity.class);
    ...
    protected void initView() {
        ...
        loadingDialog = new ProgressDialog(LinshiSelectChongzhiPayMethodActivity.this);
    ...
    protected void initInstance() {
        ...
        BCPay.initWechatPay(LinshiSelectChongzhiPayMethodActivity.this, getString(R.string.wx_app_id));
    }
...
//				paymentAmout = 1;
                if (payType == 0) {//支付宝
                    ...
                    BCPay.getInstance(LinshiSelectChongzhiPayMethodActivity.this).reqAliPaymentAsync(
                            "Android支付宝支付-点滴",
                            (int) paymentAmout,
                            billId,
                            mapOptional,
                    ...
                    if (BCPay.isWXAppInstalledAndSupported() &&
                        ...
                        BCPay.getInstance(LinshiSelectChongzhiPayMethodActivity.this).reqWXPaymentAsync(
                                "Android微信支付-点滴",               //订单标题
...
//        Intent intent = new Intent(LinshiSelectChongzhiPayMethodActivity.this, QianbaoZhangdanActivity.class);
