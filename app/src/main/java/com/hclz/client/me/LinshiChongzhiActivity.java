...
public class LinshiChongzhiActivity extends BaseActivity {
    ...
    public static void startMe(Context from){
        Intent intent = new Intent(from, LinshiChongzhiActivity.class);
    ...
    protected void initView() {
        ...
        iv_comm_head_left.setImageResource(R.mipmap.ic_guanbi);
    }
                    ...
                    new SanmiAsyncTask.ResultHandler() {
                        ...
                        public void callBackForServerSuccess(String result) {
                            ...
                            Intent intent = new Intent(
                                    LinshiChongzhiActivity.this,
                                    LinshiSelectChongzhiPayMethodActivity.class);
                            ...
                            LinshiSelectChongzhiPayMethodActivity.startMe(mContext,bill.getBillid(),bill.getPrice(),SharedPreferencesUtil.get(mContext, ProjectConstant.APP_USER_MID));
                            finish();
                        }
