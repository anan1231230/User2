 ...
 */
public class JieHuoGuanliFragment extends BaseVFragment {
    ...
    public static JieHuoGuanliFragment newInstance() {
        JieHuoGuanliFragment fragment = new JieHuoGuanliFragment();
...
//            content.put(ProjectConstant.PLATFORM, configMap.get(ProjectConstant.CONFIG_PLATFORM));
            ...
            content.put("cid",SharedPreferencesUtil.get(mContext,"cid"));
            PostHttpUtil.prepareParams(requestParams, content.toString());
            sanmiAsyncTask.excutePosetRequest(ServerUrlConstant.CSHOP_ORDER_CHECK_UNRECEIVED.getShopMethod(), requestParams,
                    new SanmiAsyncTask.ResultHandler() {
                        @Override
                        public void callBackForServerSuccess(String result) {
    ...
    private void showContent(){
        ...
        BadgeBean.getInstence().badges[1] = mData.size() +"";
