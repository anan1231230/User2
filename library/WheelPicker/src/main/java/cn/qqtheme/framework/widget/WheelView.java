...
public class WheelView extends ScrollView {
    ...
    public static final int TEXT_COLOR_FOCUS = Color.parseColor("#626262");
    public static final int TEXT_COLOR_NORMAL = 0XFFBBBBBB;
    public static final int LINE_COLOR = Color.parseColor("#00FFFFFF");
...
//        views.setPadding(0, dip2px(10), 0, dip2px(10));
        addView(views);
    }
    ...
    private TextView createView(String item) {
        ...
        tv.setPadding(padding, dip2px(10), padding, dip2px(10
